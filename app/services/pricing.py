...
PRODUCTS = {
    ...
    "buyer_pro_monthly": {
        ...
        "price_sgd": 399,
        "price_cents": 39900,
        "description": "Structured procurement teams — 50 Quick + 20 Deep Scans/month (11-dimension PDPA assessment + certifications + financial-risk scoring), drift tracking across Deep Scan parameters, comparison engine, customisable risk weights, 3 seats, webhooks, 5 notarizations/month",
        "type": "subscription",
    ...
    "buyer_enterprise_monthly": {
        ...
        "price_sgd": 799,
        "price_cents": 79900,
        "description": "Audit-ready for enterprise / MAS-regulated procurement — 100 Quick + 100 Enhanced + 15 Evidence Scans/month, on-chain log, custom frameworks, RBAC, RESTful API, 20 notarizations/month",
        "type": "subscription",
